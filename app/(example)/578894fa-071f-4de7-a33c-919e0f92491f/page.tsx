...
import {
  ContextStore,
  ScrollNavbarSlideDown,
  ShowHere,
} from '@/components/example/scroll-navbar-slide-down-in-view';

export const metadata: Metadata = {
  title: 'Scroll Navbar Slide Down In View',
  description: 'Scroll Navbar Slide Down In View',
};
  ...
  return (
    <ContextStore>
      ...
      <div className={cn('mx-auto w-full max-w-4xl', 'py-10')}>
        <h1 className="font-serif text-5xl font-extrabold">Scroll Down</h1>
        ...
        <div className="my-10">Navbar show before here</div>
